		...
		<div class="row">
			<select id="gradeLevel" name="v_grd" class="browser-default font40 col s4"><!-- grade level-->
			...
			<select id="section" name="v_sec" class="browser-default font40 col s6 push-s1"> 
			</select>
