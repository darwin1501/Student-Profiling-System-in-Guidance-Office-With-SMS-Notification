...
$_SESSION['school_id'] = $school_id;
 header ("Location: admin_edit_school.php");// this will reload the page 
}
//  delete button
...
//  header ("Location: admin_edit_student.php"); // this will reload the page 
// }
// // if the edit button was click
		...
		<div class="card-panel student-content z-depth-3"><!--  card panel start-->
			...
			<nav>
				<div class="nav-wrapper green">
					<ul id="nav-mobile">
						<li class="active"><a href="admin_edit_student.php">Student Profile</a></li>
						<li><a href="admin_violation_page.php">Violation</a></li>
					</ul>
				</div>
			</nav>
		<div class="row">
		 ...
		 <div style="margin-top:80px;">
		 	...
		 	<!-- this form is for updating student info. "form2.php"-->
