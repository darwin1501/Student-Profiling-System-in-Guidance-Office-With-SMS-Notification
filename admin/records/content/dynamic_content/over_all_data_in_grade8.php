<!-- ############################# GRADE 8 ################################-->
<div class="collapsible-header green"><b class="white-text"><h4>Grade 8</h4></b></div>
<div class="collapsible-body">
	<button class="btn blue tbl2">export</button>
	<div class="row">
		...
		<br>
		<br>
		<table class="striped table2excel2" data-tableName="Test Table 1">
			<thead>
				<tr>
					<th>Section</th>
