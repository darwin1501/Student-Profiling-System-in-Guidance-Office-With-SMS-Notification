...
// this session was get into the admin_edit_student page
//########################################
$telno = $_SESSION['tel'];
$lrn = $_SESSION['lrn'];
...
// if the checkbox was check to notify thr parents.
...
<html>
	...
	<!--  card panel start-->
	<div class="card-panel add-violation-content z-depth-3">
		<form method="POST">
			<?php echo $output ?>
		<!-- violation form -->	
		...
		<!-- button -->
			<div class="row">
				<div class=" col m4 l6 push-l3  push-m3 ">
					<a href="admin_violation_page.php" class="waves-effect waves-dark blue-grey lighten-4 black-text btn btn">
						Go Back
					</a>
				</div>
				<div class="row">
