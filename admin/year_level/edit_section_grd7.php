...
if($num1==1){
	//find the section
	 $grd7_query = mysqli_query($con," SELECT * FROM grd7 where `grd7_id` = '".$_SESSION['grd7_id']."' ");
	 //result
	 $result = mysqli_fetch_array($grd7_query);
	 //find the advisers
	$find_advisers = mysqli_query($con, "SELECT * FROM g7_advisers WHERE `section` = '".$result['section']."'");

if ($_SERVER["REQUEST_METHOD"] == "POST"){

$section	 = mysqli_real_escape_string($con, $_POST['section']);
$adviser	 = mysqli_real_escape_string($con, $_POST['adviser']);
// update section in table grd7
$sql1 = mysqli_query($con, "UPDATE grd7 set section = '$section', adviser = '$adviser' WHERE `grd7_id` = '".$_SESSION['grd7_id']."' ");
...
// $update_sec = mysqli_query($con, " UPDATE all_sec set section = '$section' WHERE section = '$section'")
		...
		<li class="no-padding">
			...
			<form method="POST" action="#">
				...
				<a href="grade7.php" class="btn grey lighten-2 black-text">GO BACK</a>
					...
					<div class="col s3 push-s3 m3 push-m3">
