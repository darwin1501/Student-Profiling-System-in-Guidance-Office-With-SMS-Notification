...
//find the section
$grd7_section = mysqli_query($con,"SELECT * FROM grd7 WHERE `grd7_id` = '".$_SESSION['grd7_id']."'");
$g7_result = mysqli_fetch_array($grd7_section);
//section
$section = $g7_result['section'];

// get all advisers in secction
$find_adviser = mysqli_query($con, "SELECT * FROM g7_advisers WHERE `section` = '$section' ORDER BY date_added DESC");

if (isset($_GET['delete'])) {
	# code...
$g7_adviser_id= $_GET["g7_adviser_id"];

		$sql= mysqli_query($con,"DELETE  FROM g7_advisers WHERE g7_adviser_id = '$g7_adviser_id '");
...
if (isset($_GET['edit'])) {
$_SESSION['g7_adviser_id'] = $_GET["g7_adviser_id"];
		...
		<?php echo $output;?>
			...
			<form method="POST" action="#">
				<div class="card-panel adviser-content z-depth-3">
					<div class="row">					
							<div class="col s4">
								<a href="grade7.php" class="btn grey lighten-2 black-text">GO BACK</a>
							</div>
						</div>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="g7_info.php?delete=1&g7_adviser_id=<?php echo $row["g7_adviser_id"];?>" onclick="return confirm('Do you want to delete this?')" class="tooltipped" data-position="top" data-delay="50" data-tooltip="Delete">
							<i class="fa fa-trash fa-2x icon-pad-5" style="color:#f44336; margin-left:10px;"></i>
						</a>
						<a href="g7_info.php?edit=1&g7_adviser_id=<?php echo $row["g7_adviser_id"];?>" class="tooltipped" data-position="top" data-delay="50" data-tooltip="Edit">
