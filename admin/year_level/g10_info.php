...
$find_adviser = mysqli_query($con, "SELECT * FROM g10_advisers WHERE `section` = '$section' ORDER BY date_added DESC");

if (isset($_GET['delete'])) {
	# code...
$g10_adviser_id= $_GET["g10_adviser_id"];

		$sql= mysqli_query($con,"DELETE  FROM g10_advisers WHERE g10_adviser_id = '$g10_adviser_id '");
		header("location:g10_info.php");

}
if (isset($_GET['edit'])) {
$_SESSION['g10_adviser_id'] = $_GET["g10_adviser_id"];

header("location:g10_edit_info.php");
	}
?>
<!-- start HTML here-->
<!DOCTYPE html>
		...
		<?php echo $output;?>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="g10_info.php?delete=1&g10_adviser_id=<?php echo $row["g10_adviser_id"];?>" onclick="return confirm('Do you want to delete this?')" class="tooltipped" data-position="top" data-delay="50" data-tooltip="Delete">
							<i class="fa fa-trash fa-2x icon-pad-5" style="color:#f44336; margin-left:10px;"></i>
						</a>
						<a href="g10_info.php?edit=1&g10_adviser_id=<?php echo $row["g10_adviser_id"];?>" class="tooltipped" data-position="top" data-delay="50" data-tooltip="Edit">
