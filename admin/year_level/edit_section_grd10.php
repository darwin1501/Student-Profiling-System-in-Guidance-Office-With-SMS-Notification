...
//find the section
$grd10_query = mysqli_query($con," SELECT * FROM grd10 where `grd10_id` = '".$_SESSION['grd10_id']."' ");
 //result
$result = mysqli_fetch_array($grd10_query);
//find the advisers
$find_advisers = mysqli_query($con, "SELECT * FROM g10_advisers WHERE `section` = '".$result['section']."'");
...
$sql1 = mysqli_query($con, "UPDATE grd10 set section = '$section', adviser = '$adviser' WHERE `grd10_id` = '".$_SESSION['grd10_id']."' ");
