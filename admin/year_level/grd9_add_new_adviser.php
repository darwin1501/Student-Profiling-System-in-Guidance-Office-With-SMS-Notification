...
$query_grd9 = mysqli_query($con, "INSERT INTO g9_advisers (section, adviser, date_added) VALUES ('$section', '$adviser','$date_format')");
		...
		<li class="no-padding">
			...
			<form method="POST" action="#">
				<div class="card-panel add-adviser-content z-depth-3">
					<div class="row">
						<div class="col s3">
							<h6 class="grey-text text-darken-1">Grade 9</h6>
						</div>
						<div class="col s3">
