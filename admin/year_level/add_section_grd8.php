...
$grd7_query = mysqli_query($con, "SELECT * FROM grd8");
...
$check_section = mysqli_query($con,"SELECT * FROM grd8 WHERE `section`='".$_POST['section']."'");
$check_adviser = mysqli_query($con,"SELECT * FROM grd8 WHERE `adviser`='".$_POST['adviser']."'");
...
$query_grd8 = mysqli_query($con, "INSERT INTO grd8 (section, adviser) VALUES ('$section', '$adviser')");
