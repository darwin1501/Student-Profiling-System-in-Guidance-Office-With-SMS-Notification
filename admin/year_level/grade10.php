...
if (isset($_GET['edit'])) {
	# code...
$_SESSION['grd10_id'] = $_GET["grd10_id"];


header("location:edit_section_grd10.php");
...
if (isset($_GET['delete'])) {
	# code...
$grd10_id = $_GET["grd10_id"];

// find section
$select_section = mysqli_query($con, "SELECT * FROM grd10 WHERE grd10_id =  $grd10_id");
// fetch result
$result = mysqli_fetch_array($select_section);

//delete section from table grd10
$sql= mysqli_query($con,"DELETE  FROM grd10 WHERE grd10_id = $grd10_id ");
...
header("location:grd10_add_new_adviser.php");
}
				...
				<li>
					...
					<div class="collapsible-body blue-grey darken-3">
						<ul>
							...
							<li class="blue-grey darken-4"><a href="grade10.php" class="white-text">Grade 10</a></li>
						</ul>
					</div>
				</li>
			</ul>
			...
			<div class="divider"></div>
				<div class="row">
					<div class=" col s1 push-s10 custom-button-top">
						<a href="add_section_grd10.php" class="tooltipped" data-position="left" data-delay="50" data-tooltip="Add Section">
				...
				<table class="striped">
					...
					<tbody>
						<?php 
						$grd10_query = mysqli_query($con, "SELECT * FROM grd10 ORDER BY section ASC");
						if (mysqli_num_rows($grd10_query ) > 0) {
							while($row = mysqli_fetch_array($grd10_query )) {
						?>
						<tr>
								...
								<td></td>
								<td>
							<a href="grade10.php?delete=1&grd10_id=<?php echo $row["grd10_id"];?>" onclick="return confirm('Do you want to delete this?')" 	class="tooltipped" data-position="top" data-delay="50" data-tooltip="Delete">
								<i class="fa fa-trash fa-4x icon-pad-5" style="color:#f44336;"></i>
							</a>
							<a href="grade10.php?edit=1&grd10_id=<?php echo $row["grd10_id"];?>" class="tooltipped" data-position="top" data-delay="50" 		data-tooltip="Edit">
								<i class="fa fa-pencil-alt fa-4x icon-pad-5" style="color:#2196f3; margin-left:10px;"></i>
							</a>
							<a href="grade10.php?add=1&grd10_id=<?php echo $row["grd10_id"];?>" class="tooltipped" data-position="top" data-delay="50" data-tooltip="Add New Adviser">
								<i class="fa fa-plus-circle fa-4x icon-pad-5 " style="color:#4caf50; margin-left:10px;"></i>
							</a>
							<a href="grade10.php?view=1&grd10_id=<?php echo $row["grd10_id"];?>" class="tooltipped" data-position="top" data-delay="50" data-tooltip="view">
