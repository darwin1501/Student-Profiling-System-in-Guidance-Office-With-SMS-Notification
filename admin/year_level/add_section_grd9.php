...
$grd9_query = mysqli_query($con, "SELECT * FROM grd9");
...
$check_section = mysqli_query($con,"SELECT * FROM grd9 WHERE `section`='".$_POST['section']."'");
$check_adviser = mysqli_query($con,"SELECT * FROM grd9 WHERE `adviser`='".$_POST['adviser']."'");
...
$query_grd9 = mysqli_query($con, "INSERT INTO grd9 (section, adviser) VALUES ('$section', '$adviser')");
