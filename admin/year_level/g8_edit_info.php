...
if($num1==1){
//find the section
$find_adviser = mysqli_query($con,"SELECT * FROM g8_advisers WHERE `g8_adviser_id` = '".$_SESSION['g8_adviser_id']."'");
...
$update = mysqli_query($con, "UPDATE g8_advisers set adviser = '$adviser' WHERE `g8_adviser_id` = '".$_SESSION['g8_adviser_id']."' ");
header("locaion:g8_edit_info.php");
$output = "<script>
		swal({
  type: 'success',
			...
			<form method="POST" action="#">
				...
				<div class="row">
					...
					<div class="col s4 push-s3 m5 push-m3">
						<a href="g8_info.php" class="btn grey lighten-2 black-text">GO BACK</a>
					</div>
