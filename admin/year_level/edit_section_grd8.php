...
//find the section
 $grd8_query = mysqli_query($con," SELECT * FROM grd8 where `grd8_id` = '".$_SESSION['grd8_id']."' ");
//result
$result = mysqli_fetch_array($grd8_query);
//find the advisers
	$find_advisers = mysqli_query($con, "SELECT * FROM g8_advisers WHERE `section` = '".$result['section']."'");

if ($_SERVER["REQUEST_METHOD"] == "POST"){
$section	 = mysqli_real_escape_string($con, $_POST['section']);
$adviser	 = mysqli_real_escape_string($con, $_POST['adviser']);
// update section in table grd8
$sql1 = mysqli_query($con, "UPDATE grd8 set section = '$section', adviser = '$adviser' WHERE `grd8_id` = '".$_SESSION['grd8_id']."' ");
