...
$check_adviser = mysqli_query($con,"SELECT * FROM g8_advisers WHERE `adviser`='".$_POST['adviser']."'");
...
$query_grd8 = mysqli_query($con, "INSERT INTO g8_advisers (section, adviser, date_added) VALUES ('$section', '$adviser','$date_format')");
		...
		<li class="no-padding">
			...
			<form method="POST" action="#">
				<div class="card-panel add-adviser-content z-depth-3">
					<div class="row">
						<div class="col s3">
							<h6 class="grey-text text-darken-1">Grade 8</h6>
						</div>
						<div class="col s6">
				...
				<div class="row"><!--  card panel start-->
					...
					<?php echo $output; ?> 
					<span class="card-title center col s8 push-s2"><h5>Add New Adviser</h5></span>
				</div>
				...
				<div class="row">
					...
					<div class="col s3 push-s4 m2 push-m2">
						<button type="submit" value="submit" class="btn blue white-text">add</button>
					</div>
