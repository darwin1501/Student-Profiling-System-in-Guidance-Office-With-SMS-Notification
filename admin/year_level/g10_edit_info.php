...
if($num1==1){
//find the section
$find_adviser = mysqli_query($con,"SELECT * FROM g10_advisers WHERE `g10_adviser_id` = '".$_SESSION['g10_adviser_id']."'");
...
$update = mysqli_query($con, "UPDATE g10_advisers set adviser = '$adviser' WHERE `g10_adviser_id` = '".$_SESSION['g10_adviser_id']."' ");
header("locaion:g10_edit_info.php");
$output = "<script>
		swal({
  type: 'success',
			...
			<form method="POST" action="#">
				...
				<div class="row">
					...
					<div class="col s4 push-s3 m5 push-m3">
						<a href="g10_info.php" class="btn grey lighten-2 black-text">GO BACK</a>
					</div>
