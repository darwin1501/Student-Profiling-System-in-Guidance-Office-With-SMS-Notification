...
$grd7_query = mysqli_query($con, "SELECT * FROM grd7");
...
$check_section = mysqli_query($con,"SELECT * FROM grd7 WHERE `section`='".$_POST['section']."'");
$check_adviser = mysqli_query($con,"SELECT * FROM grd7 WHERE `adviser`='".$_POST['adviser']."'");
...
$query_grd7 = mysqli_query($con, "INSERT INTO grd7 (section, adviser) VALUES ('$section', '$adviser')");
