...
if($num1==1){
//find the section
$find_adviser = mysqli_query($con,"SELECT * FROM g9_advisers WHERE `g9_adviser_id` = '".$_SESSION['g9_adviser_id']."'");
...
$check_adviser = mysqli_query($con,"SELECT * FROM g9_advisers WHERE `adviser`='".$_POST['adviser']."'");
...
$update = mysqli_query($con, "UPDATE g9_advisers set adviser = '$adviser' WHERE `g9_adviser_id` = '".$_SESSION['g9_adviser_id']."' ");
header("locaion:g9_edit_info.php");
$output = "<script>
		swal({
  type: 'success',
			...
			<form method="POST" action="#">
				...
				<div class="row">
					...
					<div class="col s4 push-s3 m5 push-m3">
						<a href="g9_info.php" class="btn grey lighten-2 black-text">GO BACK</a>
					</div>
