...
// select all section in grade 7
$grd10_query = mysqli_query($con, "SELECT * FROM grd10");
...
$check_section = mysqli_query($con,"SELECT * FROM grd10 WHERE `section`='".$_POST['section']."'");
$check_adviser = mysqli_query($con,"SELECT * FROM grd10 WHERE `adviser`='".$_POST['adviser']."'");
...
}elseif ($check_section->num_rows != 0) {
$output = "<script>
swal({
  type: 'error',
...
$query_grd10 = mysqli_query($con, "INSERT INTO grd10 (section, adviser) VALUES ('$section', '$adviser')");
		...
		<li class="no-padding">
			...
			<form method="POST" action="#">
				...
				<div class="row"><!--  card panel start-->
					...
					<?php echo $output; ?>
					<h6 class="blue-text">Grade 10</h6>
