...
include("auth/login_admin_process.php");
?>
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
		<form method="POST">
			<div class="container">
				<div class="card-panel card-opacity custom-card z-depth-5">
					<?php echo $output;?>
					<div class="white-text text-darken-4 center-align"><h5>Administrator Login</h5></div>
					<div class="row">
					...
					<div class="row">
						<div class="col s1 push-s1" style="margin-top:5%;">
							...
							<div class="input-field col s8" style="margin-left:10%;">
								...
								<label class="active" for="first_name2" required>Password</label>
							</div>
					</div>
	
					<div class="row">
						<div class="col s5 push-s2">
							<a href="ps_recover/admin_recover.php" style="color:#f5f5f5"><h6>Forgot password?</h6></a>
						</div>
